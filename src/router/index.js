...
import blocks from "../components/pages/profileDashboard/common/manageProfile/blocks.vue";
...
import Transactions from "../components/pages/profileDashboard/vendor/transactions/transactions.vue";

import searchIndex from "../components/pages/searchResult/index.vue";
import allResult from "../components/pages/searchResult/all.vue";
import productsResults from "../components/pages/searchResult/productsResults.vue";
import imagesResults from "../components/pages/searchResult/imagesResults.vue";
import videosResults from "../components/pages/searchResult/videosResults.vue";
// import shopResults from "../components/pages/searchResult/shop.vue";
import companyResults from "../components/pages/searchResult/company.vue";
import personalResults from "../components/pages/searchResult/personal.vue";

import chatHome from "../components/pages/chat/chatHome.vue";
// Advertising
import Advertising from "../components/pages/profileDashboard/Advertisment/advertising.vue";
// Property Category
import propertyPurpose from "../components/pages/profileDashboard/vendor/property/propertyPurpose.vue";
import propertyCategory from "../components/pages/profileDashboard/vendor/property/propertyCategory.vue";
import propertyType from "../components/pages/profileDashboard/vendor/property/propertyType.vue";
// Auto Category
import autoCategory from "../components/pages/profileDashboard/vendor/auto/autoCategory.vue";
import autoSubCategory from "../components/pages/profileDashboard/vendor/auto/autoSubCategory.vue";
// saved items favorites
import savedItems from "../components/pages/profile/savedItems.vue";
...
const router = new Router({
  routes: [
    ...
    //   name: "appHome",
    //   component: () =>
    //     new Promise(resolve => setTimeout(() => resolve(dsMarket), 1000))
    // },
    {
      path: "/ctshots",
      name: "ctShots",
    ...
    },
    {
      ...
      children: [
        ...
        // this route for see more page in profileStore page
        {
          path: "/profilestore/category/:name/:id",
          component: demands
        },
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "/:name/:id/create/advertising/",
          name: "Advertising",
          component: Advertising
        },
        {
          path: "/:name/:id/savedItems/",
          name: "savedItems",
          component: savedItems
        },
        {
          path: "/:name/:id/favorites/",
          name: "favorites",
          component: favorites
        }
      ]
    ...
    // },
    {
      ...
      children: [
        ...
        {
          path: "/dashboard/vendor/manage-transactions/",
        ...
        {
          path: "/dashboard/vendor/add-new-property",
        ...
        {
          path: "/dashboard/vendor/add-new-property/property-type",
        ...
        { path: "/dashboard/vendor/auto/details", component: autoCategory },
        {
          path: "/dashboard/vendor/auto/details/features",
          component: autoSubCategory
        },
        {
          path: "vendor/addAuto",
          name: "addAuto",
