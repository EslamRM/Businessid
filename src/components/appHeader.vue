                ...
                <div class="col-auto">
                  <div class="bx-tp-1">
                    <router-link to="/" class="cmp-logo-main">
                      <img
                        :src="
                          'https://storage.googleapis.com/businessid-bucket-1/uploads/18Oct2020235235_J5ckUTK0KG.png'
                        "
                        alt
                      />
                    </router-link>
                ...
                <div class="col-auto">
                  <div class="bx-tp-1 app-menu app-menu-wrap">
                    ...
                    <!-- <md-button
                      class="md-primary cartBtnWrap"
                      :md-ripple="true"
                      @click="$store.dispatch('notificationCheck'),showNoti=!showNoti"
                    >
                      <a>
                        <div class="cartCount">
                          <i class="material-icons">notifications</i>
                    ...
                    <div v-if="showNoti" class="noti-list">
            ...
            <div class="drawer-content">
              ...
              <ul class="tabs">
                ...
                <li>
                  ...
                  >
                    <span> <i class="material-icons">article</i> </span>My
                    Orders
                  </router-link>
                </li>
                <!-- <li>
                ...
                <li>
                  <router-link
                    ...
                    "
                  >
                    <span> <i class="material-icons">campaign</i> </span
                    >Advertising
                  </router-link>
                </li>
                <li>
...
import notifications from "./pages/notification/notification.vue";
...
.noti-list >>> .wrapper_notification {
  max-width: 100%;
  width: 100%;
}
.noti-list >>> .pzero {
