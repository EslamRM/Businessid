<template>
  <div>
                    ...
                    <div class="category-menu-wrapper">
                      ...
                      <div class="menu filter-left">
                        <div class="cst-bx-v-1">
                          <div class="section-title-statisticsHome">
                            <h2>Location</h2>
    ...
    <md-dialog :md-active.sync="showMobileFilterState">
      <md-dialog-title
        >Filter
        <i class="material-icons md-primary" @click="closeFilter"
          >close</i
        ></md-dialog-title
      >
    ...
    <div v-if="showMobileFilterState">
...
export default {
  ...
  computed: {
    ...
    showMobileFilterState() {
      return this.$store.getters.getToggleMobileFilterFlag;
    },
  },
  watch: {
    showMobileFilterState(old, newVal) {
  ...
  methods: {
    closeFilter() {
      console.log("event");
      this.$store.dispatch("showMobileFilter", false);
...
.md-dialog-content > .mobile-filter-section-title {
  padding: 0px;
  min-height: unset;
}
.show-bx-1 {
...
.fltr-pg-1 .section-title-statisticsHome h2 {
  color: #212121;
...
.fltr-pg-1 .section-title-statisticsHome i {
  font-size: 17px;
  float: right;
}
