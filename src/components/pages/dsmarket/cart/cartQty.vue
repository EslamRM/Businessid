  ...
  methods: {
    ...
    changQty(type) {
      if (typeof parseInt(this.qty == "number")) {
        ...
        const data = {
          cart_id: this.cart.pk_cart_id,
          quantity: this.qty,
          productid: this.cart.pk_product_id
        };
        var price = this.cart.offerprice > 0 ? this.cart.offerprice : this.cart.unitprice;
        const qtyData = {
          type: type,
          qty: this.qty,
          price: price,
