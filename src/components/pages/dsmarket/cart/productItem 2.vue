  ...
  <li>
    <div class="imgHolder">
      <router-link
        ...
        ><img :src="cart.image.file" alt=""
      /></router-link>
      <!-- <figure v-lazyload class="image__wrapper">
        <div class="loading"></div> -->

      <a href="#" class="link">
        <img :src="cart.image.file" alt="" class="fitItem"
      /></a>
    ...
    <div class="description">
        ...
        <div class="price-wrap">
          <div>
            <span class="sellingCurrency"
              >{{ currencySymbol(cart.unitprice, cart.currency)[0] }}
            </span>
            <span class="offer" v-if="cart.offerprice > 0">{{
              currencySymbol(cart.offerprice, cart.currency)[1]
            }}</span>
            <span class="sellingPrice" v-else>{{
              currencySymbol(cart.unitprice, cart.currency)[1]
            }}</span>
          </div>
          <div class="offer" v-if="cart.offerprice > 0">
            <span class="offerPrice"
              >{{ currency(cart.unitprice, cart.currency) }}
            </span>
          </div>
        </div>
        <div class="offer-discount" v-if="cart.offerpercentage > 0">
          <span class="offer-discount-content">
            {{ cart.offerpercentage }}% OFF
          </span>
        </div>
      </div>
      <!-- <div class="price">
      ...
      <div class="btmActionWrap">
        ...
        <div
          ...
          @click="removeCart(cart.fk_product_id, cart.name, cart)"
        >
