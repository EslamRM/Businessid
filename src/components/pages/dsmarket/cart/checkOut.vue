<template>
  <div>
    <div v-if="showcheckout">
      ...
      <div class="container container_padding flow_hidden" v-else>
        <section>
          ...
          <section class="col-sm-5 col-md-5 col-xl-3 left fl">
            <div class="summary">
              <div class="contentarea">
                ...
                <div>
                  <div class="cartProdcuts">
                    <ul v-if="items.length">
                      <li v-for="item in items[0].items" :key="item.pk_cart_id">
                        <div class="imgHolder">
                          <a href="#" class="link">
                            <img :src="item.variation.files[0]" alt />
                          </a>
                        </div>
                        <div class="description">
                          ...
                          <div class="price-wrap">
                            <div class>
                              <span class="offer" v-if="item.offerprice > 0">
                          ...
                          <div class="boxWrap">
                            ...
                            <div class="option" v-if="item.variation.color">
                              Color: {{ item.variation.color }}
                            </div>
                            <div class="option" v-if="item.variation.pricing_type=='pricing'">
                              Size: {{ item.variation.size.size }}
                            </div>
                            <div v-else class="option" style="color: #298d00 !important">
                              Custom order
                            </div>
                          </div>
                        </div>
                ...
                <div class="price-content" v-if="items.length">
                  <div class="detail">
                    Subtotal
                    <span
                      >{{
            ...
            <div class="sectionFlow" v-if="show_payment_sel_section">
              ...
              <div class="payment-wrap">
                ...
                <div class="paymentOption" v-if="payment_options.length > 0">
                  <div v-for="payment in payment_options" :key="payment.value">
                    <!-- div
                    ...
                    >
                      ...
                      >
                        <img src="../cart/paypal.png" width="28" class="mr-2" />
                        Paypal Checkout
                      </md-radio>
                    </div>
                    <div
                ...
                <div
                  v-show="show_paypal_buttons_wrap"
      ...
      if (this.addressbox && profile_id) {
        try {
          ...
          if (this.payment_method == "paypal") {
            ...
            var amount_in_dollar =
              this.aed_to_usd_rate * this.items[0].grand_total;
