      ...
      <div class="changeWrap">
        <div class="sectionFlow">
          <div class="cart-head">
            ...
            <a @click="$router.go(-1)" class="d-flex align-items-center back-to-address">
              <span class="material-icons">keyboard_arrow_left</span>Back to Address
            </a>
          </div>
                      ...
                      <div class="formField">
                        <div class="col-sm-12 p-0 fl">
                          <div class="md-layout-item col-sm-6 fl mb_pr_pl">
                            <md-field
                              :class="{
                                'md-invalid':
                                  this.submitted && !$v.form.contactname.required,
                              }"
                            >
                              <label>Name</label>
                              <md-input v-model="form.contactname" required></md-input>
                              <span class="md-error">Name is Required</span>
                            </md-field>
                          </div>
                          <div class="md-layout-item col-sm-6 fl mb_pr_pl margin_top">
                            <template>
                              <vue-tel-input
                                :class="{
                                  'extra-invalid':
                                    this.submitted && !$v.form.contactnumber.required,
                                }"
                        ...
                        <div class="col-sm-12 p-0 fl">
                          <div class="md-layout-item col-sm-6 fl mb_pr_pl mob_mt">
                            ...
                            >
                              ...
                              <md-input v-model="form.building" required></md-input>
                          ...
                          <div class="md-layout-item col-sm-6 fl mb_pr_pl">
                            <md-field
                              :class="{
                                'md-invalid': this.submitted && !$v.form.roomno.required,
                              }"
                            >
                              <label>Room no.</label>
                              <md-input v-model="form.roomno" required></md-input>
                        ...
                        <div class="col-sm-12 p-0 fl">
                          <div class="md-layout-item col-sm-6 fl mb_pr_pl">
                            <md-field
                              :class="{
                                'md-invalid': this.submitted && !$v.form.area.required,
                              }"
                            >
                              <label>Area</label>
                          ...
                          <div class="md-layout-item col-sm-6 fl mb_pr_pl">
                            <md-field
                              :class="{
                                'md-invalid': this.submitted && !$v.form.street.required,
                              }"
                            >
                              <label>Street</label>
                              <md-input
                        ...
                        <div class="col-sm-12 p-0 fl">
                          <div class="md-layout-item col-sm-6 fl mb_pr_pl">
                            <md-field
                              :class="{
                                'md-invalid': this.submitted && !$v.form.country.required,
                              }"
                            >
                              <md-select
                                name="country"
                          ...
                          <div class="md-layout-item col-sm-6 fl mb_pr_pl">
                            <md-field
                              ...
                              :class="{
                                'md-invalid': this.submitted && !$v.form.city.required,
                              }"
                            >
                              <md-select
                                name="city"
                            ...
                            <md-field v-else>
                              <label>City</label>
                              <md-input disabled :placeholder="citiesStatus"></md-input>
                            </md-field>
                          </div>
                        </div>
                        <div class="col-sm-12 p-0 fl">
                          <div class="md-layout-item col-sm-6 fl mb_pr_pl">
                            ...
                            >
                              ...
                              <md-input v-model="form.landmark" required></md-input>
                          ...
                          <div class="md-layout-item col-sm-6 fl mb_pr_pl">
                            <md-field
                              :class="{
                                'md-invalid':
                                  this.submitted && !$v.form.postal_code.required,
                              }"
                            >
                              <label>Emirates Code</label>
                              <md-input v-model="form.postal_code"></md-input>
                              <!-- <span class="md-error"
                        ...
                        <div class="col-sm-12 p-0 fl">
                          <div class="md-layout-item col-sm-6 fl mb_pr_pl">
                            <md-field
                              :class="{
                                'md-invalid':
                                  this.submitted && !$v.form.available_from_time.required,
                              }"
                            >
                              <i
                          ...
                          <div class="md-layout-item col-sm-6 fl mb_pr_pl">
                            <md-field
                              :class="{
                                'md-invalid':
                                  this.submitted && !$v.form.available_to_time.required,
                              }"
                            >
                              <i
                                class="material-icons"
                        ...
                        <div class="addressLabel label_box">
                          <label
                            :class="{
                              'extra-invalid': this.submitted && !$v.form.type.required,
                            }"
                            >Address Label</label
                          >
                          <md-radio v-model="form.type" value="home">Home</md-radio>

                          <md-radio v-model="form.type" value="work" class="small-padd"
                            >Work</md-radio
                          >
                        </div>
                        ...
                        <div
                          ...
                          class="lauoutWrap"
                        >
                          <label class="extra-invalid" style="padding-bottom: 20px">
                            Please Select Location From Above Map.
                            <p style="color: grey">Click on "Locate Me" button.</p>
                          </label>
                        </div>
  ...
  methods: {
    async addressDetails(addressid) {
      try {
        ...
        this.form.available_from_time = this.form.available_from_time.replace(/ /g, "T");
        this.form.available_to_time = this.form.available_to_time.replace(/ /g, "T");
      } catch (error) {
        console.log(error);
      }
    },
    async addNewAddress() {
      ...
      if (this.$v.$invalid) {
        ...
        this.$store
          ...
          .catch((error) => {
            this.$swal.fire(
              this.$helpers.successPopup("Address Not Update. Please Try Again.")
            );
            console.log(error);
          });
      }
    ...
    onClickAddMap(value) {
      ...
      if (data.length == 1) {
        ...
        this.form.street = data[0].long_name;
        ...
        this.form.area = data[2].long_name;
