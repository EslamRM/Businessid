<template>
  <div>
    <div v-if="isMobileCheck == 'true' || isTabletCheck == 'true'">
      <homeMainSlider :banners="LoadBanners" v-if="LoadBanners.length > 0" />
      <mobileCategoryBlock />
      <categoryGrid :banners="LoadBanners" v-if="LoadBanners.length > 0" />
                            ...
                            >
                              ...
                              <ul v-if="sub_category.categories.length > 0">
                                <li
                                  class=""
                                  v-for="(
                                    third_category, index
                                  ) in sub_category.categories"
                                  :key="index"
                                >
                                  <router-link
                                    :to="
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      LoadBanners: (state) => state.homepage.dsbannerslider,
    }),
  },
  methods: {
