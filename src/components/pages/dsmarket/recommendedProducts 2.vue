              ...
              <div class="bravo-offer-image">
                ...
                >
                  ...
                  <div class="offer-image">
                    <img
                      class="inner-img"
                      :src="newProduct.images[0].file"
                      :alt="newProduct.images[0].file"
                    />
                  </div>
                </router-link>
              </div>
              <div class="main-section contentWrapProduct">
                ...
                <div class="price-wrap">
                  <div class="bravo-offer-moq">
                    ...
                    <span class="sellingPrice" v-if="newProduct.offerprice > 0">
                      {{
                        currencySymbol(
...
.cartbtnBig button {
  ...
  width: 100%;
  margin-top: 0.5em;
      color: rgba(255,87,34,.65)!important;
