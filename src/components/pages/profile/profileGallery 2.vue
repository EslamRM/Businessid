<template>
  <div>
    <Ctshots :model="'gallery'" :profileid="profileId" />
       <!-- <div v-if="showImage" class="image-wrap">
               <h2 class="nodata">NO IMAGES FOUND</h2>
...
import Ctshots from '../ctshots/ctShots'
export default {
  components: { ListImages,Ctshots },
  data() {
    return {
      page:0,
      showLoader:false,
    ...
    computed: {
    photos(){
      return this.$store.getters.getProfilephotos;
    },
     profileId() {
