<template>
  <div class="follow-bx-widget">
    ...
    <div
      ...
      class="cnt-flwr-txt brdr-1 follow-box"
      :class="following == 'disabled' ? 'profileMe' : ''"
    >
      <span class="countBold">{{ folowing_count }}</span>
      <span class="">Following</span>
    </div>
    <md-dialog :md-active.sync="showFollowers" class="md-currency">
      <md-dialog-title class="d-flex preview-title"
        ><h2 class="mx-auto">Followers</h2>
        <div class="close">
          <i
      ...
      <md-content md-dynamic-height class="mx-5 mb-5">
        <div class="">
          <button class="btn_ad2 btn-box">
            <div class="follow-div d-flex">
              <span class="follow-img"
                ><img
                  src="https://via.placeholder.com/150"
                  alt="test"
                  style="border-radius:50%;"/></span
              ><span class="follow-name">eslam</span>
            </div>
          </button>
          <button class="btn_ad2 btn-box">
            <div class="follow-div d-flex">
              <span class="follow-img"
                ><img
                  ...
                  alt="test"
                  style="border-radius:50%;"/></span
              ><span class="follow-name">Muaath</span>
            </div>
          </button>
          <button class="btn_ad2 btn-box">
            <div class="follow-div d-flex">
              <span class="follow-img"
                ><img
                  ...
                  alt="test"
                  style="border-radius:50%;"/></span
              ><span class="follow-name">afsal</span>
            </div>
          </button>
          <button class="btn_ad2 btn-box">
            <div class="follow-div d-flex">
              <span class="follow-img"
                ><img
                  ...
                  alt="test"
                  style="border-radius:50%;"/></span
              ><span class="follow-name">islam</span>
            </div>
          </button>
        </div>
      </md-content>
    </md-dialog>
    <md-dialog :md-active.sync="showFollowing" class="md-currency">
      <md-dialog-title class="d-flex preview-title"
        ><h2 class="mx-auto">Following</h2>
        <div class="close">
          <i
            class="material-icons md-primary"
            style="cursor: pointer"
...
.follow-div .follow-img {
  display: flex;
  flex: 1;
  max-width: 12%;
}
.follow-div .follow-name {
  display: flex;
  flex: 1;
  align-items: center;
  justify-content: end;
