  ...
  <div>
    ...
    <div class="col-sm-12 col-md-12 col-xl-12 fl wrapper_order_table">
      ...
      <md-dialog :md-active.sync="showDialog">
        ...
        <div class="col-sm-12 col-md-12 col-xl-12 fl modal-body" v-if="showDialog">
          <div class="col-sm-12 p-0 fl">
          ...
          <div class="col-sm-6 pr-0 mob_pr fl margin_mobile mob_mr_two">
            <vue-tel-input v-model="invite.mobile" placeholder="Mobile"></vue-tel-input>
            <div class="c-forminlineError" v-if="checkValidationInvite('mobile')">
          ...
          <div class="col-sm-6 pl-0 mob_pl fl margin_selection_third">
            ...
            ></v-select>
            <div class="c-forminlineError" v-if="checkValidationInvite('nationality')">
          ...
          <div class="col-sm-6 pr-0 fl mob_pr margin_radio radio_btn_request">
            ...
            <div class="c-forminlineError" v-if="checkValidationInvite('gender')">
              <span> Gender is required </span>
            </div>
          </div>
          <div class="col-sm-12 pr-0 pl-0 fl mob_pl margin_selection_third">
            <p class="label">User Permissions</p>
            <md-checkbox @change="grantAll" v-model="grantAllFlag">Admin </md-checkbox>
            <div>
              <md-checkbox
      ...
      <md-dialog :md-active.sync="showDialog2">
        <div class="row container">
          <div class="modal-header" style="width: 100%">
            <md-dialog-title>Edit Staff</md-dialog-title>
          </div>
          <div class="col-sm-12 col-md-4 col-xl-2 fl modal-body" v-if="showDialog2">
            <div
              class="staff"
              v-for="(item, id) in staff"
              :key="id"
              v-if="(showDialog2, item.profileid == permissionID)"
            >
              <div class="staff-container mt-3">
                <div data-v-6c39182c="" class="bravo-offer-image">
                  <div data-v-6c39182c="" class="ctlistItem">
                    <img
                      data-v-6c39182c=""
                      src="https://w7.pngwing.com/pngs/449/541/png-transparent-t-shirt-training-personal-trainer-health-television-fitness-coach-tshirt-television-physical-fitness.png"
                      alt="own the run t-shirt blue"
                      class="fitItem"
                      style="width: 50%; border-radius: 10%; height: 50%"
                    />
                  </div>
                </div>
                <div data-v-6c39182c="" class="main-section contentWrapProduct">
                  <div data-v-6c39182c="" class="product-name mt-3">
                    ID: {{ item.profileid }}
                  </div>
                  <div data-v-6c39182c="" class="mt-2">
                    <div data-v-6c39182c="" class="bravo-offer-moq">
                      <span data-v-6c39182c="" class="sellingPrice mt-2 mb-2">
                        <router-link
                          v-if="item.status"
                          :disabled="true"
                          :to="
                  ...
                  <div data-v-6c39182c="" class="mt-2 job-name2">
                    <div
                      data-v-6c39182c=""
                      class="bravo-offer-moq"
                      style="overflow: visible"
                    >
                      <span data-v-6c39182c="" class="sellingPrice">
                        <input type="text" v-model="item.user.designation" />
                        <!-- <md-input v-model="invite.designation"></md-input> -->
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-sm-12 col-md-8 col-xl-10 fl modal-body" v-if="showDialog2">
            <p class="label">User Permissions</p>
            <div class="col-sm-12 pr-0 pl-0 fl mob_pl margin_selection_third">
              <div
                v-for="(item, id) in staff"
                :key="id"
                v-if="item.profileid == permissionID"
              ...
              >
                  ...
                  <i
                    ...
                    @click="
                      (showDialog2 = false),
                        ...
                        (newPermissions[id].permissions = [...staff[id].permissions])
                    "
                  >
                    close
                  </i>
                </div>
                <div class="md-layout" v-if="newPermissions[0].permissions">
                  <div
                ...
                <div
                  class="md-item-layout md-size-50 md-alignment-center-space-between buttonDiv"
                  v-if="newPermissions[id].editting"
                >
                  <md-button
                    class="md-raised md-primary btn_save"
                    @click="
                      updatePermission(item.profileid, newPermissions[id].permissions);
                      newPermissions[id].editting = false;
                      showDialog2 = false;
                      editDesignation();
                    "
      ...
      >
        <div class="list-wrapper">
          <div class="listItemShow listUsers">
            <div
              data-v-eb306cea=""
              class="offer-item2"
              v-for="(item, id) in staff"
            ...
            >
              ...
              >
                <div data-v-6c39182c="" class="row-columns">
                  <a data-v-6c39182c="" class="full-width"
                    ><div data-v-6c39182c="" class="bravo-offer-image">
                      <div data-v-6c39182c="" class="ctlistItem">
                        <img
                          data-v-6c39182c=""
                    ...
                    <div data-v-6c39182c="" class="main-section contentWrapProduct">
                      <div data-v-6c39182c="" class="product-name" v-model="permissionID">
                        ID: {{ item.profileid }}
                      </div>
                      <div data-v-6c39182c="" class="mt-2">
                        <div data-v-6c39182c="" class="bravo-offer-moq">
                      ...
                      <div data-v-6c39182c="" class="mt-2 job-name">
                        <div data-v-6c39182c="" class="bravo-offer-moq">
                          <span data-v-6c39182c="" class="sellingPrice">
                      ...
                      <div class="bottom-action mt-3">
                        <div class="">
                          <div class="md-item-layout md-size-50">
                            <md-button class="md-raised md-primary btn_edit m-0">
                              <span
                                :class="{
                        ...
                        <div class="md-item-layout md-size-50">
                          <md-button
                            ...
                            @click="
                              editPermissions(),
                                (permissionID = item.profileid),
                                (newPermissions[id].editting = true)
                            "
                          >
...
import { required, minLength, numeric, email, checked } from "vuelidate/lib/validators";
...
export default {
  ...
  methods: {
    ...
    async inviteUser() {
      ...
      try {
        const postResponse = await axios.post("/vendor/add-sub-user", this.invite);
        if (postResponse.data.success) {
          this.inviteLoading = false;
          this.showDialog = false;
          this.refresh();
          this.$swal.fire(this.$helpers.successPopup(postResponse.data.message));
          return;
        } else {
          this.inviteLoading = false;
          this.showDialog = false;
    ...
    async updatePermission(userid, permissions) {
      try {
        const response = await axios.post("/vendor/update-sub-user-permissions", {
          userid,
          permissions,
        });
...
.btn_edit {
  ...
  background: rgb(33 58 99 / 11%) !important;
}
.btn_edit i {
  color: #333;
}
...
.btn_delete {
  min-width: 20px;
  height: 32px;
  background-color: rgb(33 58 99 / 11%) !important;
  border-radius: 3px;
  width: 38px;
  margin: 0px 8px !important;
}
