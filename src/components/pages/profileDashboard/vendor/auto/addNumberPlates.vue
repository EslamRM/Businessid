    ...
    >
      <div class="md-layout-item">
        <div class="frm-hdr-1-txt txt-algn-lft">
          {{ demandOrSupplyPrefix() }} Number Plates
        </div>
      </div>
...
export default {
  ...
  data () {
    return {
      ...
      breadcrumbs: [
        ...
        {
          title: this.demandOrSupplyPrefix() + " Number Plates",
          link: "/dashboard/vendor/addNumberPlates?market_type=" + this.$route.query.market_type,
        }
      ],
      extraFeatures: [
        {
  ...
  created () {
    ...
    this.getAutoTypes("api_auto_types", { parentid: "986" }, "sub_categories");
    this.getAutoTypes(
