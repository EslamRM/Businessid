    ...
    <div class="md-layout md-alignment-center-space-between page-title">
      <div class="md-layout-item">
        <div class="frm-hdr-1-txt txt-algn-lft">
          {{ demandOrSupplyPrefix() }} Heavy Vehicles
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      breadcrumbs: [
        ...
        {
          title: this.demandOrSupplyPrefix() + " Heavy Vehicles",
          link:
            "/dashboard/vendor/addHeavyVehicles?market_type=" +
            this.$route.query.market_type
        }
      ],
      extraFeatures: [
  ...
  created() {
    ...
    this.getAutoTypes("api_auto_types", { parentid: "3" }, "sub_categories");
    this.getAutoTypes(
