    ...
    <div v-else>
        ...
        <div class="mob_auto_details">
          ...
          >
            <input-component
              v-if="
                form.auto_type == 'Used' &&
                  form.category != 'Accessories And Spare Parts'
              "
              size="33"
              type="text"
      ...
      <form-section number="8" title="Add Contact Details">
        <div class="mb_three_tab mb_mb_5 mb_mt_contact desktop_mb_5">
          ...
          <div
            class="md-layout md-gutter mt-4 md-alignment-center-center mb_mt_5"
          >
            <input-component
              label="Country *"
              custom="true"
      ...
      >
        <div
          ...
          style="color: #e01e5a; margin: 10px"
        >
...
export default {
  ...
  validations() {
    ...
    if (
      ...
      this.form.category === "Heavy Vehicles"
    ) {
      fields = { ...fields, ...Cars };
      // fields.body_type = {
      //   required
      ...
      breadcrumbs: [
        ...
        },
        {
          title: this.$route.query.productId
            ...
            : this.demandOrSupplyPrefix() +
              this.$route.query.category.slice(0, -1) +
              "",
          link:
            "/dashboard/vendor/addCar?market_type=" +
            this.$route.query.market_type
        }
      ],
