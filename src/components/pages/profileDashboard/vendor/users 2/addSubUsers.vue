      ...
      <md-dialog :md-active.sync="showDialog">
        ...
        >
          ...
          <div class="col-sm-6 pr-0 fl mob_pr margin_radio radio_btn_request">
            <p class="label">&nbsp;</p>
            <md-radio v-model="invite.gender" value="male"
              >Business man</md-radio
            >
            <md-radio v-model="invite.gender" value="female"
          ...
          <md-table-row v-for="(item, id) in staff" :key="id" class="bg_row">
            ...
            <md-table-cell class="action_column">
              <div class="md-layout width_btn_user">
                <div
                  class="md-item-layout md-size-50 md-alignment-center-space-between "
  ...
  methods: {
    ...
    async inviteUser () {
      ...
      try {
        ...
        console.log(error);
        this.inviteLoading = false
        this.$swal.fire(this.$helpers.errorPopup("Error inviting user. Please try again."));
        return
      }
    ...
    async deleteUser (userid, id) {
      ...
      if (Reasons) {
        try {
          ...
          if (await success) {
            await this.$swal.fire(this.$helpers.successPopup("User Deleted Successfully."))
            console.log(id)
