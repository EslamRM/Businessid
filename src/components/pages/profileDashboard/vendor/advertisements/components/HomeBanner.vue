    ...
    >
      ...
      <div class="carousel_adevertisement">
        <div class="cover-slider">
          <div
            class="big_img_add"
            @click="toggleCropper({ width: 1270, height: 400 })"
    ...
    >
      ...
      <div class="carousel_adevertisement">
        <div class="cover-slider">
          <div
            class="big_img_add"
            @click="toggleCropper({ width: 1270, height: 150 })"
            v-if="banners.ads.length <= 0"
          >
            <i data-v-72e9c9bd="" class="material-icons">add</i>
          </div>
...
export default {
  ...
  methods: {
    ...
    toggleCropper(res) {
      ...
      console.log(res);
      if (res.height == 375) {
        this.stencilHeight = 550;
        this.stencilWidth = 1900;
      } else if (res.height == 190) {
        this.stencilHeight = 390;
        this.stencilWidth = 985;
      } else if (res.height == 150) {
        this.stencilHeight = 210;
        this.stencilWidth = 1950;
      }
