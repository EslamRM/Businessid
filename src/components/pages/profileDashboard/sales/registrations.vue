  ...
  <div>
    ...
    <div>
      <div class="md-layout wrapper_order_table">
        ...
        <div class="col-sm-6 pr-0 mob_pr mob_pr fl margin_email_mob">
          ...
          >
            ...
            <md-input
              ...
              required
            ></md-input>
            <span class="md-error" v-if="isEmailDuplicate"
              >Please enter unique email. It should be different than other
              emails.</span
            >
            <span class="md-error" v-if="checkValidity('email')"
              >Please enter Valid Email</span
            >
            <span class="md-error" v-else>Email is required</span>
          </md-field>
        </div>
        ...
        <div
          class="col-sm-6 pr-0 mob_pr fl margin_selection margin_license_mob"
        >
          <fileInput
        ...
        <div class="md-layout md-gutter select-fieldset">
          ...
          <div class="md-layout-item md-size-50" v-if="this.freezoneNames">
            <input-component custom="true" label="Freezone Name *">
              <v-select
                label="name"
                :reduce="(el) => el.name"
        ...
        <div class="col-sm-12 pb-2 fl">
          ...
          >
            <div class="limitRadio">
              <md-radio v-model="form.payment_method" value="Online" checked
                >Online</md-radio
              >

              <md-radio v-model="form.payment_method" value="Cheque" checked
                >Cheque</md-radio
              >
              <md-radio v-model="form.payment_method" value="Cash" checked
                >Cash</md-radio
              >
            </div>
          </input-component>
          <h4 class="title_main" v-if="form.payment_method === 'Cheque'">
            Cheque Details
          </h4>
          <div
      ...
      <div class="col-sm-12 col-md-12 col-xl-12 fl wrapper_order_table">
          ...
          <div class="md-layout">
            <md-button class="md-dense btn_accept">
              <md-checkbox v-model="terms_and_conditions">{{
                terms_and_conditions ? "Accepted" : "Accept"
              }}</md-checkbox>
            </md-button>
            <md-button
        ...
        <md-dialog :md-active.sync="showDialog">
          ...
          <md-dialog-actions>
            <md-button class="md-primary" @click="handleModalClick('reject')"
              >Reject</md-button
            >
            <md-button
        ...
        if (success) {
          ...
          if (this.form.payment_method === "Online") {
            window.location.replace(
              `${process.env.VUE_APP_BASE_URL}business/register-subscription?token=${token}`
            );
          }
    ...
    valueEntered($event, type) {
      ...
      if ($event.target && $event.target.value) {
        type === "managers"
          ...
          : (this.personsDirty = true);
        return;
      }
      type === "managers"
        ? (this.managersDirty = false)
        : (this.personsDirty = false);
      return;
    },
