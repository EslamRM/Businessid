  ...
  <div>
    <md-dialog :md-active.sync="showDialog">
      <div class="modal-header">
        <md-dialog-title>Update Profile Picture</md-dialog-title>
        <div class="modal-close">
          <i class="material-icons" @click="showDialog = false">
            close
          </i>
        </div>
      </div>
...
.photo-capture >>> .photo-capture-actions {
  background: #ffffff00;
  position: fixed;
  bottom: 10px;
  text-align: center;
}
.photo-capture >>> .photo-capture-actions button {
  margin: 10px;
  padding: 10px;
  border: 0;
  border-radius: 10px;
