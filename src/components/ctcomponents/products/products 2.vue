                  ...
                  <div class="category-menu-wrapper">
                    <div class="menu">
                      ...
                      <div class="cst-bx-v-1">
                        ...
                        <div class="show-bx-1 ctSelect show_bx_2">
              ...
              <div class="container-floor2">
                ...
                >
                  <div :class="{ listactiveBox: gridActivated }">
                    <!-- <navwithImageSlider></navwithImageSlider> -->
                    <ctListingBox> </ctListingBox>
...
import navwithImageSlider from "../navwithImageSlider";
import { isMobile, isTablet } from "mobile-device-detect";

import VueTagsInput from "@johmun/vue-tags-input";
import ctListingBox from "../products/ctListingBox";
...
export default {
  ...
  watch: {
    $route: function(to, from) {
      ...
      //     if (typeof this.filters[element] == "string") {
      //       this.filters[element] = "";
      //     } else if (typeof this.filters[element] == "object") {
      //       this.filters[element] = [];
      //     }
      //   });
      //   this.filters.page = 0;
