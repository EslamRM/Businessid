    ...
    <div class="bravo-normal-offer hide-btm-padd">
      ...
      >
        <div class="ctlistItem forAuto" v-if="auto.images.length">
          <img :src="auto.images[0].file" :alt="auto.name" class="autoHeroImg" />
        </div>
      </router-link>
        ...
        <div class="descriptionWrap">
          ...
          <div v-if="moreDetails != null">
            <div class="optionLine muted" v-if="moreDetails(auto) != null">
              {{ moreDetails(auto).address }},{{ moreDetails(auto).location_area }},{{
            ...
            <div class="smallSummary">
              <div class="optionLine" v-if="moreDetails(auto) != null">
                <span class="icoWrap"><img src="../autos/km.png" class="kmIcon" /></span>
                <div class="resultIn">
...
.listItemShow[data-v-be229408] {
  display: inline-flex;
}

.listIte @media screen and (max-width: 600px) {
  .forAuto {
